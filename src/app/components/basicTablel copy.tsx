...
const Example = (props) => {
    ...
    // const accessorKey= props.colums.accessorKey;
    // const header= props.colums.header;
    // const enableEditing= props.colums.enableEditing !== undefined ? props.colums.enableEditing : true;
    // const xs= props.colums.xs !== undefined ? props.colums.xs : 4;
    // const required= props.colums.required !== undefined ? props.colums.required : false;
    // const renderCreate= props.colums.renderCreate !== undefined ? props.colums.renderCreate : true;
    // const renderEdit= props.colums.renderEdit !== undefined ? props.colums.renderEdit : true;
    ...
    const columns = 
            [
                ...
                },
                {
                    ...
                    >
                        {cell.getValue<number>()?.toLocaleString?.('ko-KR', {
                        style: 'currency',
                        currency: 'KRW',
                        minimumFractionDigits: 0,
                        maximumFractionDigits: 0,
                ...
                },
                {
                    ...
                    Cell: ({ renderedCellValue }) => {
                        const isChecked = renderedCellValue == 'Y';
                        return (
                            <Checkbox
                                checked={isChecked}
                                readOnly
...
const table = useMantineReactTable({
    ...
    mantineTableBodyRowProps: ({ row }) => ({
        ...
        onClick: () => {
            console.log('선택된 행 데이터:', row.original); 
            setRowSelection({
